...
class Program
{
    static StudentPerformanceTracker studentPerformanceTracker = new StudentPerformanceTracker();
        ...
        while (StudentPerformanceTrackerLoop)
        {
            ...
            switch (UserOption)
            {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    SearchStudentDetailsByIdOrName();
                    break;
                case 5:
    ...
    static void SearchStudentDetailsByIdOrName()
    {
    ...
    static void DisplayAllStudentDetails()
    {
